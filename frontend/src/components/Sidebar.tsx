...
export default function Sidebar() {
  ...
  useEffect(() => {
    ...
    const initialAccent: Accent =
      savedAccent &&
      accents.some((item) => item.id === savedAccent)
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 h-screen w-[240px] border-r border-[var(--border)] bg-[var(--sidebar-bg)] px-[8px] py-[14px] text-[var(--text)] transition-colors">
      ...
      <Link
        href="/profile"
        className="flex cursor-pointer items-center justify-between rounded-[8px] px-[8px] py-[4px] hover:bg-[var(--hover)]"
      >
        <div className="flex items-center gap-[7px]">
          <div className="flex h-[25px] w-[25px] items-center justify-center rounded-full bg-[var(--accent)] text-[10px] font-semibold text-white">
            {avatarLetter}
          </div>
      ...
      <div className="mt-[24px]">
        ...
        <div className="mt-[14px] space-y-[2px]">
          ...
          <button
            ...
            className="flex h-[31px] w-full items-center justify-between rounded-[8px] px-[8px] text-[12px] font-medium text-[var(--text)] hover:bg-[var(--hover)]"
          >
            ...
            <div className="ml-[4px] rounded-[9px] border border-[var(--border)] bg-[var(--surface)] p-[4px] shadow-[0_8px_24px_rgba(0,0,0,0.08)]">
              {(["light", "dark"] as Theme[]).map((item) => (
                <button
                  ...
                  className={`flex h-[29px] w-full items-center justify-between rounded-[7px] px-[8px] text-[12px] capitalize hover:bg-[var(--hover)] ${
                    theme === item
                      ? "bg-[var(--active-bg)] text-[var(--accent)]"
                      : "text-[var(--text)]"
                  }`}
            ...
            <div className="ml-[4px] rounded-[9px] border border-[var(--border)] bg-[var(--surface)] p-[4px] shadow-[0_8px_24px_rgba(0,0,0,0.08)]">
              {accents.map((item) => (
                <button
                  ...
                  className={`flex h-[29px] w-full items-center justify-between rounded-[7px] px-[8px] text-[12px] hover:bg-[var(--hover)] ${
                    accent === item.id
                      ? "bg-[var(--active-bg)] text-[var(--accent)]"
                      : "text-[var(--text)]"
                  }`}
      ...
      <Link
        ...
        className={`absolute bottom-[20px] left-[16px] z-50 flex h-[36px] w-[36px] items-center justify-center rounded-full border text-[12px] font-medium transition-colors ${
          isProfileActive
