  ...
  return (
    ...
    >
      <div
        ...
        className="w-[435px] rounded-xl border border-[var(--border)] bg-[var(--surface)] p-5 shadow-lg"
      >
        {/* Header */}
        ...
        <div className="mt-5 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="mt-1 w-full resize-none rounded-lg border border-[var(--border)] px-3 py-2 text-[14px] outline-none focus:border-[var(--accent)]"
            />
          </div>
